...
Our additional analysis revealed a meta-analytic effect size of $g = `r summ_gender$intercept`$, 95% Crl [`r summ_gender$intercept.lower`, `r summ_gender$intercept.upper`] (Supplementary Fig. 1) and a probability of this effect being greater than zero of `r print_perc(hyp_gender$Post.Prob)`.
