...
The heterogeneity of effect sizes was $\sigma_{\text{Experiment}}^2 = `r summ_gender$sigma2_experiment`$, 95% CrI [`r summ_gender$sigma2_experiment.lower`, `r summ_gender$sigma2_experiment.upper`], at the experiment level and $\sigma_{\text{Article}}^2 = `r summ_gender$sigma2_article`$, 95% CrI [`r summ_gender$sigma2_article.lower`, `r summ_gender$sigma2_article.upper`] at the article level. This means that `r print_perc(summ_gender$icc)` of the total variance can be attributed to differences *between* articles and `r print_perc(1 - summ_gender$icc)` to differences between experiments *within* articles.
