...
|                                                                | $d=\frac{m_\text{movel}-m_\text{familiar}}{{SD}_\text{av}}$;\quad then (1)                  |
+----------------------------------------------------------------+---------------------------------------------------------------------------------------------+
...
$${SE}_\text{rotation}=\sqrt{\frac{{df}}{{df}-2}\frac{2(1-r)}{n}\left(1+g_\text{rotation}^2\frac{n}{2(1-r)}\right)-\frac{g_\text{rotation}^2}{J^2}}$$
...
$${SE}_\text{gender}=\sqrt{\frac{{df}}{{df}-2}\frac{2}{\tilde{n}}\left(1+g_\text{gender}^2\frac{\tilde{n}}{2}\right)-\frac{g_\text{gender}^2}{J({df})^2}}$$

Where $\tilde{n}$ is the harmonic mean of the group sizes
(i.e., $\tilde{n}=\frac{n_\text{female}n_\text{male}}{n_\text{female}+n_\text{male}}$)
and ${df}$ are the degrees of freedom as provided in row (1) of Table 2.
A sensitivity analysis highlights the stability of the effect size computed using the Bayesian meta analysis (Supplementary Table 5).
