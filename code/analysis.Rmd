...
print(res_mv)
forest(res_mv)
funnel(res_mv, main = "Standard Error")
egger <- regtest(x = res_mv$yi, vi = res_mv$vi, sei = res_mv$sei, model = "lm", predictor = "sei")
print(egger)
...
print(res_age)
forest(res_age)
funnel(res_age, main = "Standard Error")
...
print(res_gender)
forest(res_gender)
funnel(res_gender, main = "Standard Error")
...
print(res_full)
forest(res_full)
funnel(res_full, main = "Standard Error")
```
