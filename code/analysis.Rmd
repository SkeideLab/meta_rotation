...
sd_experiment_draws <- as.matrix(
  res_brm,
  variable = "sd_article:experiment__Intercept"
)
mean_qi(sd_experiment_draws^2)

# Compute by-article variance
sd_article_draws <- as.matrix(
  res_brm,
  variable = "sd_article__Intercept"
)
mean_qi(sd_article_draws^2)

# Compute intra-class correlation
icc_draws <- sd_article_draws^2 / (sd_article_draws^2 + sd_experiment_draws^2)
mean_qi(icc_draws)
