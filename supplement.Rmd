...
# Add footnotes
colnames(tabs5)[6] <- str_c(colnames(tabs5)[6], "\\textsuperscript{a}")
tabs5$` `[8] <- str_c(tabs5$` `[8], "\\textsuperscript{b}")
tabs5$` `[9] <- str_c(tabs5$` `[9], "\\textsuperscript{c}")
tabs5$` `[10] <- str_c(tabs5$` `[10], "\\textsuperscript{d}")
tabs5$` `[11] <- str_c(tabs5$` `[11], "\\textsuperscript{e}")
...
# Add footnotes
tabs6$` `[8] <- str_c(tabs6$` `[8], "\\textsuperscript{a}")
tabs6$` `[9] <- str_c(tabs6$` `[9], "\\textsuperscript{b}")
tabs6$` `[10] <- str_c(tabs6$` `[10], "\\textsuperscript{c}")
tabs6$` `[11] <- str_c(tabs6$` `[11], "\\textsuperscript{d}")
...
tabs7$` `[1] <- str_c(tabs7$` `[1], "\\textsuperscript{b}")
tabs7$` `[2] <- str_c(tabs7$` `[2], "\\textsuperscript{c}")
tabs7$` `[3] <- str_c(tabs7$` `[3], "\\textsuperscript{d}")
tabs7$` `[4] <- str_c(tabs7$` `[4], "\\textsuperscript{e}")
...
# Save the tables
tabs8 <- tabs_correction$meta
tabs9 <- tabs_correction$gender
write_csv(tabs8, file = here(tables_dir, "tabs8_correction_meta.csv"))
write_csv(tabs9, file = here(tables_dir, "tabs9_correction_gender.csv"))
```

```{r, tabs8, include=TRUE}
# Add footnotes
colnames(tabs8)[4] <- str_c(colnames(tabs8)[4], "\\textsuperscript{a}")
colnames(tabs8)[7] <- str_c(colnames(tabs8)[7], "\\textsuperscript{b}")
...
# Add footnotes
colnames(tabs9)[4] <- str_c(colnames(tabs9)[4], "\\textsuperscript{a}")
colnames(tabs9)[7] <- str_c(colnames(tabs9)[7], "\\textsuperscript{b}")
