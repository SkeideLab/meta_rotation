...
# Create seperate tables for the two different meta-analyses (rotation/gender)
...
apa_table(
  tabs_trim_fill_selection$meta,
  align = "llccccc",
  caption = "Trim-and-fill and selection models for the meta-analysis of mental rotation performance",
  font_size = "scriptsize",
  escape = FALSE
)
apa_table(
  tabs_trim_fill_selection$gender,
  align = "llccccc",
  caption = "Trim-and-fill and selection models for the meta-analysis of gender differences",
  font_size = "scriptsize",
  escape = FALSE
)
```

```{r, figs4, include=TRUE, fig.width=12, fig.height=3.5}
